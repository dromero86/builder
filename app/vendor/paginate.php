...
class Paginator
{
    ...
    public function toHtml()
    {
        ...
        if ($this->getPrevUrl()) {
            $html .= '<li><a href="' . $this->getPrevUrl() . '">&laquo; Anterior</a></li>';
        }
        foreach ($this->getPages() as $page) {
            if ($page['url']) {
                $html .= '<li><a href="' . $page['url'] . '" ' . ($page['isCurrent'] ? ' class="active"' : '') . '>' . $page['num'] . '</a></li>';
            } else {
                $html .= '<li class="disabled"><span>' . $page['num'] . '</span></li>';
            }
        }
        if ($this->getNextUrl()) {
            $html .= '<li><a href="' . $this->getNextUrl() . '">Siguiente &raquo;</a></li>';
        }
        $html .= '</ul>';
        return $html;
    }
